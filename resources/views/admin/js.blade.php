...
<script src="{{asset('admincss/vendor/jquery/jquery.min.js')}}"></script>
    ...
    <script src="{{ asset('admincss/js/category.js') }}"></script>
    <script src="{{ asset('admincss/js/subCategory.js') }}"></script>
    <script src="{{ asset('admincss/js/cusOpportunities.js') }}"></script>
